...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="fa fa-times text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="glyphicon glyphicon-upload text-info hidden"></i>',
        ...
        dragSettings: {},
        indicatorNew: '<i class="glyphicon glyphicon-hand-down text-warning hidden"></i>',
    ...
    tFileIcon = '<i class="fa fa-file-image-o kv-caption-icon"></i>';
    ...
    tActionUpload = '<button type="button" class="hidden kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '{uploadIcon}</button>';
    tActionZoom = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>';
    tActionDrag = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>';
    tTagBef = '<div class="file-preview-frame{frameClass} col-md-1" id="{previewId}" data-fileindex="{fileindex}"' +
